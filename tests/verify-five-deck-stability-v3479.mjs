...
assert.equal(pkg.version,'34.7.20','package version');
assert.match(sync,/const VERSION = '34\.7\.20';/,'Worker bridge version');
assert.match(html,/V34\.7\.20/,'visible V34.7.20 marker');
...
console.log('V34.7.20 five-deck large synced roster static stability verification: PASS');
