...
assert.equal(pkg.version,'34.7.9','package version');
assert.match(sync,/const VERSION = '34\.7\.9';/,'Worker bridge version');
assert.match(html,/V34\.7\.9/,'visible V34.7.9 marker');
...
console.log('V34.7.9 five-deck large synced roster static stability verification: PASS');
