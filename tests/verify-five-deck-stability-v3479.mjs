...
assert.equal(pkg.version,'34.7.13','package version');
assert.match(sync,/const VERSION = '34\.7\.13';/,'Worker bridge version');
assert.match(html,/V34\.7\.13/,'visible V34.7.13 marker');
...
console.log('V34.7.13 five-deck large synced roster static stability verification: PASS');
