...
assert.equal(pkg.version,'34.7.17','package version');
assert.match(sync,/const VERSION = '34\.7\.17';/,'Worker bridge version');
assert.match(html,/V34\.7\.17/,'visible V34.7.17 marker');
...
console.log('V34.7.17 five-deck large synced roster static stability verification: PASS');
