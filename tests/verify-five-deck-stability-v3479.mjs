...
assert.equal(pkg.version,'34.7.12','package version');
assert.match(sync,/const VERSION = '34\.7\.12';/,'Worker bridge version');
assert.match(html,/V34\.7\.12/,'visible V34.7.12 marker');
...
console.log('V34.7.12 five-deck large synced roster static stability verification: PASS');
