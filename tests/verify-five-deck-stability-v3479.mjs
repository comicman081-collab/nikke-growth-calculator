...
assert.equal(pkg.version,'34.7.16','package version');
assert.match(sync,/const VERSION = '34\.7\.16';/,'Worker bridge version');
assert.match(html,/V34\.7\.16/,'visible V34.7.16 marker');
...
console.log('V34.7.16 five-deck large synced roster static stability verification: PASS');
