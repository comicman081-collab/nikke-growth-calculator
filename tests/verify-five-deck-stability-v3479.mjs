...
assert.equal(pkg.version,'34.7.14','package version');
assert.match(sync,/const VERSION = '34\.7\.14';/,'Worker bridge version');
assert.match(html,/V34\.7\.14/,'visible V34.7.14 marker');
...
console.log('V34.7.14 five-deck large synced roster static stability verification: PASS');
