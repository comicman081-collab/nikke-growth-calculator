...
assert.equal(pkg.version,'34.7.11','package version');
assert.match(sync,/const VERSION = '34\.7\.11';/,'Worker bridge version');
assert.match(html,/V34\.7\.11/,'visible V34.7.11 marker');
...
console.log('V34.7.11 five-deck large synced roster static stability verification: PASS');
