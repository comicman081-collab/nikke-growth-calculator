...
assert.equal(api.version,'34.7.17');
...
console.log('V34.7.17 ENIKK 21 favorite characters / 21 TIDs / 63 phase cards / base skills / level preservation / calculation regression: PASS');
