...
assert.match(rootHtml,/V34\.7\.15/,'V34.7.15 branding');
...
assert.equal(synced.version,'34.7.15');
...
console.log('V34.7.15 BlaBla bridge + four-surface propagation static verification: PASS');
