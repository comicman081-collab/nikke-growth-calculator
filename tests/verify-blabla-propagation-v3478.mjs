...
assert.match(rootHtml,/V34\.7\.17/,'V34.7.17 branding');
...
assert.equal(synced.version,'34.7.17');
...
console.log('V34.7.17 BlaBla bridge + four-surface propagation static verification: PASS');
