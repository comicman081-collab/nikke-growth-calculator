...
assert.match(rootHtml,/V34\.7\.10/,'V34.7.10 branding');
...
assert.equal(synced.version,'34.7.10');
...
console.log('V34.7.10 BlaBla bridge + four-surface propagation static verification: PASS');
