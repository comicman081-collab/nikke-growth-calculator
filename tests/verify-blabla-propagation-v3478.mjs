...
assert.match(rootHtml,/V34\.7\.16/,'V34.7.16 branding');
...
assert.equal(synced.version,'34.7.16');
...
console.log('V34.7.16 BlaBla bridge + four-surface propagation static verification: PASS');
