...
assert.match(rootHtml,/V34\.7\.8/,'V34.7.8 branding');
...
assert.equal(synced.version,'34.7.8');
...
console.log('V34.7.8 BlaBla bridge + four-surface propagation static verification: PASS');
