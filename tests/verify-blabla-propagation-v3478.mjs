...
assert.match(rootHtml,/V34\.7\.9/,'V34.7.9 branding');
...
assert.equal(synced.version,'34.7.9');
...
console.log('V34.7.9 BlaBla bridge + four-surface propagation static verification: PASS');
