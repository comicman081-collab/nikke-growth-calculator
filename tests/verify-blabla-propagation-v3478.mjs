...
assert.match(rootHtml,/V34\.7\.18/,'V34.7.18 branding');
...
assert.equal(synced.version,'34.7.18');
...
console.log('V34.7.18 BlaBla bridge + four-surface propagation static verification: PASS');
