...
assert.match(rootHtml,/V34\.7\.13/,'V34.7.13 branding');
...
assert.equal(synced.version,'34.7.13');
...
console.log('V34.7.13 BlaBla bridge + four-surface propagation static verification: PASS');
