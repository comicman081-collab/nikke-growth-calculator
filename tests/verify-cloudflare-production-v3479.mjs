...
for(let attempt=1;attempt<=90;attempt+=1){
  try{
    ...
    if(result.response.ok&&deployedHtml.includes('V34.7.9')&&deployedHtml.includes('id="v3479-five-deck-stability"'))break;
    lastError=`attempt ${attempt}: HTTP ${result.response.status}; v3479=${deployedHtml.includes('V34.7.9')}; marker=${deployedHtml.includes('id="v3479-five-deck-stability"')}`;
...
console.log('V34.7.9 Cloudflare production HTML + configured bridge + live BlaBla roster verification: PASS');
