...
try{
 ...
 console.log(JSON.stringify({version:'34.7.20',boss:'luxuriousSpiderS40',formerFineTotal:former.fineTotal,...report,pass:true},null,2));console.log('V34.7.20 coarse-to-fine 1/2-team contender rerank: PASS');
