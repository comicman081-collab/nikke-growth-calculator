...
try {
  ...
  console.log(JSON.stringify({version:'34.7.13',boss:'luxuriousSpiderS40',modes:report,runtimeExceptions,fatalConsole,pageCrashes,pass:true},null,2));
  console.log('V34.7.13 S40 auto/owned/allEqual production-mode verification: PASS');
} finally {
  cdp?.close();
