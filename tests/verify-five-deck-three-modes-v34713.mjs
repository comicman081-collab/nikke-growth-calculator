...
try {
  ...
  console.log(JSON.stringify({version:'34.7.16',boss:'luxuriousSpiderS40',modes:report,runtimeExceptions,fatalConsole,pageCrashes,pass:true},null,2));
  console.log('V34.7.16 S40 auto/owned/allEqual production-mode verification: PASS');
} finally {
  cdp?.close();
