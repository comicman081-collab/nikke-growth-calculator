...
async function run(ev){
 ...
 }finally{state.active=null;if(parts.panel)parts.panel.setAttribute('aria-busy','false');if(parts.button){parts.button.disabled=false;parts.button.textContent='현재 로스터로 V34.7.19 5팀 계산';}try{root.scrollTo(0,scrollY);}catch(_){}}})();
