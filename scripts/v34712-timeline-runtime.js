...
function makeDetails(id,label){const d=root.document.createElement('details');d.open=false;d.id=id;d.className='v34712-timeline-details';d.innerHTML=`<summary>${esc(label)}</summary><div class="v34712-timeline-body"><div class="v34712-loading">타임라인을 누르면 계산 결과를 시간축으로 펼칩니다.</div></div>`;return d;}
